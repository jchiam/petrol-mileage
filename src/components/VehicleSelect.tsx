...
export function VehicleSelect({ vehicles, value, onChange, className }: VehicleSelectProps) {
          ...
          {vehicles.map((v) => {
            ...
            return (
              <button
                ...
                className="flex items-center gap-2 w-full px-3 py-2 text-sm text-gray-900 hover:bg-gray-50 text-left"
              >
